    ...
    <header>
        <div class="container header-container">
            ...
            <div class="header-icons">
                ...
                <button class="mobile-menu-btn" id="mobileMenuBtn"><emclass="fas fa-bars"></em></button>
            </div>
        </div>
    </header>
            ...
            <div class="footer-container">
                <div class="footer-col">
                    ...
                    <div class="social-links">
                        <a href="#"><emclass="fab fa-facebook-f"></em></a>
                        <a href="#"><emclass="fab fa-twitter"></em></a>
                        <a href="#"><emclass="fab fa-instagram"></em></a>
                        <a href="#"><emclass="fab fa-youtube"></em></a>
                    </div>
                </div>
                <div class="footer-col">
                    <h3>Shop</h3>
